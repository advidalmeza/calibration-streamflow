...
#source combined performance calculating function 
source(here("R", "cper.R")) #combining NSE and relative error with 50/50 weighting 

nse
relerr
cper

#evaluate performance for sager data
...
source(here("R", "highflowmetrics.R"))

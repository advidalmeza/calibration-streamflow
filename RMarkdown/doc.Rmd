...
This metrics allowed us to quantitatively assess the performance of each simulation relative to the observations. The box plots and line graph allowed us to qualitatively assess the performance of the highest performing simulations against each other and the observations. Our analysis showed that the two highest performing simulations (S15 and S89) were relatively equal at predicting annual maximum stream flow but S89 was a lot better at predicting maximum stream flow in May. 
